...
<div class="manual">
  <p>
    To complete the illusion, we also need to apply motion to the elements that
    aren't transitioning. For this, we use the animate directive./p>
  </p>
  <p>First, import the flip function</p>
  <p>
  ...
  <p>
    ...
    rather than JavaScript, meaning they won't block (or be blocked by) the main
    thread.
  </p>
</div>
